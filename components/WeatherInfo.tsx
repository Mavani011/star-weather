    ...
    const cardData = [
        {
            ...
            color: " linear-gradient(90deg, #236a74, #04504c, #0a3431",
            icon: <FaWind />,
        },
        {
            title: 'Humidity',
    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4 text-gray-400">
                {cardData.map((item, i) => (
                    <div key={i} className={`rounded-lg md:rounded-xl bg-gray-800 p-3 md:p-4 pt-3 shadow-md uyf`} style={{ background: item.color }}>
