        ...
        <section>
            ...
            <div className="flex flex-col gap-1.5 md:gap-3 text-center">
                {data.map((day, index) => (
                    <div
                        key={day.dt}
                        className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr] items-center gap-2 rounded-lg px-4 py-3 text-xs md:text-sm text-whiite-300 shadow-md" 
                        style={{background: "linear-gradient(90deg,rgb(110, 45, 91), rgb(94, 32, 82),rgb(77, 21, 83),rgb(56, 8, 61),rgb(40, 5, 43),rgb(39, 3, 39));"}}>
